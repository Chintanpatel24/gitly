...
module.exports = async (req, res) => {
  ...
  try {
    ...
    res.end(generatePRCard({ username, pullRequests: prs }));
  } catch (e) {
    res.end(generatePRCard({ username, pullRequests: [] }));
  }
};

function errSVG(msg) {
  return `<svg width="495" height="60" xmlns="http://www.w3.org/2000/svg">
    <rect width="495" height="60" rx="8" fill="#0d1117" stroke="#f85149" stroke-width="1"/>
